    ...
    <main className="flex-1 w-full bg-[#F7F9FB] py-16 md:py-24">
      <div className="max-w-7xl mx-auto px-6 lg:px-8 space-y-16 md:space-y-24">
        ...
        <section className="space-y-6 max-w-3xl">
          <div className="inline-flex items-center px-4 py-1.5 bg-[#71F8E4] rounded-full">
            <span className="text-xs font-bold text-[#00201C] tracking-wider uppercase">
              EXPERTISE & CARE
            </span>
          </div>
          ...
          <p className="text-lg text-[#45474C] leading-relaxed">
            Advanced dermatological solutions blending medical precision with aesthetic excellence. Our clinic specializes in clinical skin health, premium aesthetics, and innovative hair restoration.
          </p>
        </section>
        ...
        <section className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-12 bg-white border border-[#C5C6CD]/40 rounded-xl p-8 md:p-12 shadow-sm flex flex-col lg:flex-row gap-12 items-center">
            ...
            <div className="flex-1 space-y-6 w-full">
              ...
              <p className="text-base text-[#45474C] leading-relaxed">
                Our board-certified dermatologists address pathological skin concerns using evidence-based protocols. We treat a wide range of conditions from chronic acne to specialized screening.
              </p>
          ...
          <div className="lg:col-span-6 bg-white border border-[#C5C6CD]/40 rounded-xl overflow-hidden shadow-sm flex flex-col">
            ...
            <div className="p-8 flex-1 flex flex-col justify-between space-y-8">
              <div className="space-y-6">
                ...
                <p className="text-sm text-[#45474C] leading-relaxed">
                  Enhance your natural features with our non-surgical rejuvenation treatments designed for subtle, long-lasting results.
                </p>
          ...
          <div className="lg:col-span-6 bg-white border border-[#C5C6CD]/40 rounded-xl overflow-hidden shadow-sm flex flex-col">
            ...
            <div className="p-8 flex-1 flex flex-col justify-between space-y-8">
              <div className="space-y-6">
                ...
                <p className="text-sm text-[#45474C] leading-relaxed">
                  Comprehensive solutions for hair thinning and scalp health using biological growth factors and light therapy.
                </p>
        ...
        <section className="bg-[#091426] text-white rounded-xl p-8 md:p-16 text-center space-y-8 relative overflow-hidden shadow-lg">
          ...
          <div className="relative z-10 max-w-3xl mx-auto space-y-6">
            ...
            <p className="text-[#8590A6] text-base md:text-lg leading-relaxed">
              Consult with our experts for a personalized skin analysis and a custom treatment roadmap designed specifically for your goals.
            </p>
